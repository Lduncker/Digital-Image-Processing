...
\begin{figure*}[p]
  ...
  \begin{minipage}[t]{0.49\textwidth}
    ...
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../output_0.png}\\[-0.1em]
    {\small (a)}\\[0.2em]
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../output_1.png}\\[-0.1em]
    {\small (b)}\\[0.2em]
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../output_4.png}\\[-0.1em]
    {\small (c)}\\[0.2em]
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../output_2.png}\\[-0.1em]
    {\small (d)}\\[0.2em]
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../output_3.png}\\[-0.1em]
    {\small (e)}
  \end{minipage}%
  \hfill%
  \begin{minipage}[t]{0.49\textwidth}
    ...
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../outputVideo/dashcam_0.png}\\[-0.1em]
    {\small (f)}\\[0.2em]
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../outputVideo/dashcam_1.png}\\[-0.1em]
    {\small (g)}\\[0.2em]
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../outputVideo/dashcam_2.png}\\[-0.1em]
    {\small (h)}\\[0.2em]
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../outputVideo/dashcam_3.png}\\[-0.1em]
    {\small (i)}\\[0.2em]
    \includegraphics[width=\linewidth,height=0.17\textheight,keepaspectratio]{../outputVideo/dashcam_4.png}\\[-0.1em]
    {\small (j)}
  \end{minipage}
  \caption{Detection results. \textbf{Left}: five held-out validation images (a)--(e). \textbf{Right}: dashcam frames (f)--(j).}
