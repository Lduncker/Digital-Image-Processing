...
labels/\{train,val\} tree of per-image text files. Each label
...
runtime with the kagglehub client.
...
\texttt{outputVideo/dashcam\_\{0--4\}.mp4}.

\begin{figure*}[h]
  \centering
  \hfill
  \begin{subfigure}[b]{0.30\textwidth}
    \includegraphics[width=\linewidth]{dashcam_0.png}
    \caption{Daytime (morning)}
    \label{fig:dash0}
  \end{subfigure}%
  \begin{subfigure}[b]{0.30\textwidth}
    \includegraphics[width=\linewidth]{dashcam_1.png}
    \caption{Daytime (morning)}
    \label{fig:dash1}
  \end{subfigure}%
  \begin{subfigure}[b]{0.30\textwidth}
    \includegraphics[width=\linewidth]{dashcam_2.png}
    \caption{Evening}
    \label{fig:dash2}
  \end{subfigure}
  \hfill
  ...
  \hfill
  \begin{subfigure}[b]{0.30\textwidth}
    \includegraphics[width=\linewidth]{dashcam_3.png}
    \caption{Night}
    \label{fig:dash3}
  \end{subfigure}%
  \begin{subfigure}[b]{0.30\textwidth}
    \includegraphics[width=\linewidth]{dashcam_4.png}
    \caption{Night}
    \label{fig:dash4}
  \end{subfigure}
  \hfill

  \caption{Best-confidence detection frame from each of the five dashcam
  clips (confidence $\ge 0.18$).  Daytime clips yield tight, high-confidence
  boxes; night clips show degraded recall and occasional false positives on
