...
\begin{figure*}[t]
  \centering
  % Row 1: Successful detections
  \begin{subfigure}[b]{0.31\textwidth}
    \includegraphics[width=\linewidth]{output_0.png}
    \caption{Police sedan, conf $=0.92$. Tight box on a standard rear plate under even lighting.}
    \label{fig:out0}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.31\textwidth}
    \includegraphics[width=\linewidth]{output_1.png}
    \caption{Pickup in bright sunlight, conf $=0.91$. Clean detection despite direct glare.}
    \label{fig:out4}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.31\textwidth}
    \includegraphics[width=\linewidth]{output_4.png}
    \caption{Small shadowed plate near image boundary, conf $=0.90$. The stride-8 head recovers the plate.}
    \label{fig:out1}
  \end{subfigure}

  \vspace{0.6em}

  % Row 2: False positives (centered)
  \begin{subfigure}[b]{0.31\textwidth}
    \includegraphics[width=\linewidth]{output_2.png}
    \caption{False positive on a hanging commercial sign, conf $=0.37$. Suppressed at threshold~$0.5$.}
    \label{fig:out2}
  \end{subfigure}\hspace{0.06\textwidth}%
  \begin{subfigure}[b]{0.31\textwidth}
    \includegraphics[width=\linewidth]{output_3.png}
    \caption{False positive on a rectangular building facade, conf $=0.14$. Suppressed at threshold~$0.5$.}
    \label{fig:out3}
  \end{subfigure}
...
We are currently running the retrained detector on frame-by-frame
extracts from Lucian's dashcam footage. This test covers continuous,
unscripted highway driving and exposes conditions absent from the
static training set: motion blur, partial occlusion, rapid
distance changes, and lens glare. Sample frames, per-condition
detection rates, and temporal consistency analysis will be included
in the next revision of this report.

\begin{figure}[h]
  \centering
  \fbox{\rule{0pt}{3cm}\rule{0.9\columnwidth}{0pt}}
  \caption{Dashcam video results --- to be included in next revision.}
  \label{fig:dashcam}
\end{figure}
